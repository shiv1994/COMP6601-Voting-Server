...
public final class HistoryContract {
    ...
    public static final String WIN_VOTES_COL = "WinningVotes";
    ...
    public static final String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(" +
            ...
            WIN_VOTES_COL + INT_TYPE + " NOT NULL, " +
    ...
    public static String insertEntry(){
        String sql = "INSERT INTO " + TABLE_NAME + "(" + ID_COL + "," + WIN_COL + "," + WIN_VOTES_COL + "," + VOTES_CAST_COL + ") " + "VALUES(?,?,?,?);";
